 ...
 * entries.
 *
 * @author	zhengzh 2017/9/20  修改java.util.zip.ZipInputStream 不支持GBK问题
 * @version	1.35, 07/31/06
 */
public
class CZipOutputStream extends CDeflaterOutputStream implements CZipConstants {

	private String encoding="UTF-8"; //add
