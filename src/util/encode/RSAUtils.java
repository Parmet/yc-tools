...
public abstract class RSAUtils {
     ...
     * @return 原文字符串。
     */
    public static String decryptString(String encrypttext,String charset) {
     ...
     */
    public static String decryptStringByJs(String encrypttext,String charset) {
        String text = decryptString(encrypttext,charset);
        if(text == null) {
            return null;
        }
