...
public final class UrlUtils {
    ...
    public static String getRealPath() throws URISyntaxException{
    	if(realpath==null){
    		realpath = UrlUtils.class.getClassLoader().getResource("/").toURI().getPath();
        	realpath=StringUtils.substringBefore(realpath, "classes");
    	}
    	return realpath;
